...
//	@SuppressWarnings("null")
	public String getXML(String xquery, boolean paginate, String page) {
...
//			}
		...
		try {
			...
			final ClassPathResource xsl = new ClassPathResource("xsl/" + (paginate ? "pagination.xsl" : "ipums-ddi-xslt.xsl"));
			
			Transformer transformer = tFac.newTransformer(new StreamSource(xsl.getFile()));
			if (paginate) transformer.setParameter("Page", page);
